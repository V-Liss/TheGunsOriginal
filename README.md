...
THE CODE IS EXTREMELY DIRTY. ONE FILE, FIRST HALF OF THE CODE IS JUST ITEM INITIALIZATION, THE REST IS HALF COMMENTED OUT CODE I SAVED JUST IN CASE AND HALF ACTUAL CODE WITH NO ACTUAL COMMENTS, AND THE VARIABLES ALL SHARE DIFFERENT NAMING STYLE. I LEFT IT INTENTIONALLY TO SHOW THE CHAOTIC DEVELOPMENT PROCESS AND COMPENSATE FOR THE LACK OF PREVIOUS VERSIONS, SINCE MY VERSION CONTROL WAS LITERALLY SAVING EACH VERSION AS DISTINCT FOLDERS AND GITHUB ACTS AS A STORAGE/PUBLISHED FINAL VERSION. CHECK main.cpp FOR PROOF OF THE AUTHENTICITY
